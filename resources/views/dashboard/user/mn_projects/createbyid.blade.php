                ...
                <form class="forms-sample" method="POST" action="/dashboard/user/mn_projects" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <select name="detail_project_id"
                            class="form-control text-dark @error('detail_project_id') is-invalid @enderror" readonly
                            disabled>
                            <option value="" disabled selected>Pilih Project</option>
                            @foreach ($detail_projects as $dt_project)
                                <option value="{{ $id }}" {{ $dt_project->id == $id ? 'selected' : '' }}>
                                    {{ $dt_project->jobdesc }}</option>
                            @endforeach
                        ...
                        <input type="hidden" name="detail_project_id" value="{{ $id }}">
                    </div>
                    <div class="form-group">
